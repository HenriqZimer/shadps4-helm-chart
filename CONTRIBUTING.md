# Contributing to shadPS4 Helm Chart
...
helm template shadps4 chart/

# Install in a test cluster
helm install shadps4-test chart/ --dry-run --debug
```
...
- Update `appVersion` in `Chart.yaml` in your PR when pinning the chart to a specific shadPS4 image
