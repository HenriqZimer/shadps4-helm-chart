...
When deploying shadPS4 using this Helm chart:
...
4. **Updates**
   ...
   - Monitor security advisories for the upstream [linuxserver/docker-shadps4](https://github.com/linuxserver/docker-shadps4) image.
